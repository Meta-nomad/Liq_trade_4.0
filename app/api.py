...
<div class="top"><div><h1>Liquidation Lab · v0.4.0 · ROI 250%</h1><div class="muted">Реальные рыночные данные · виртуальные деньги · реальные ордера отключены</div></div><div class="badge">PAPER ONLY</div></div>
